...
for i in range(50):
    ...
    content = driver.find_element_by_css_selector(
        '#_pcmap_list_scroll_container ul li:nth-child(' + str(i) + ') ._3ZU00 ._3LMxZ:first-child')
    ...
    place_introduce = soup.select_one(
        '.place_section_content ._3__3i ._1h3B_ .M_704._4FheO .WoYOw').text
    print('소개 : ' + place_introduce)

    # place time
    place_introduce_open = driver.find_element_by_css_selector(
        '.place_section_content ._2KHqk ._1h3B_ ._2BDci._1OkoP')
    place_introduce_open.click()
    time.sleep(0.5)

    place_time_lists = driver.find_elements_by_css_selector(
        '.place_section_content ._2KHqk ._1h3B_ ._2BDci._1OkoP._3XVfx ._20pEw').text
