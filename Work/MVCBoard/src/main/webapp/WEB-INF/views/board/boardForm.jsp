    ...
    <div class="container" role="main">
        ...
        <form name="form" id="form" role="form" method="post" action="/board/write">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="postName" id="postName" placeholder="제목을 입력해 주세요">
            </div>
            <div class="mb-3">
                <label for="postWriter">닉네임</label>
                <input type="text" class="form-control" name="postWriter" id="postWriter" placeholder="닉네임을 입력해 주세요">
            </div>
